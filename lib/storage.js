...
export const Storage = {
  ...
  async addStepCompleted(arg = {}) {
    ...
    return this.updateStats({ totalStepsCompleted: s.totalStepsCompleted + 1, foodStock: s.foodStock + foodAdd, petLevel, petExp });
  },
  async addTaskCompleted(bonus = {}) {
    ...
    let petLevel = s.petLevel, petExp = s.petExp + expAdd;
    while (petExp >= petLevel * 20) { petExp -= petLevel * 20; petLevel += 1; }
    return this.updateStats({ totalTasksCompleted: s.totalTasksCompleted + 1, foodStock: s.foodStock + foodAdd, petLevel, petExp });
  },
};
